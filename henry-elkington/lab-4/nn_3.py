...
# A four-layer MLP:
# ```
# Input (WINDOW_SIZE × VOCAB_SIZE) → Hidden (64, ReLU) → Hidden (32, ReLU) → Hidden (16, ReLU) → Output (VOCAB_SIZE)
# ```
...
# %% Generate a song
test_progression = ["I", "IV", "V", "i", "bVII", "i", "bVII"]
...
for i in range(0, len(final_progression), 8):
    print(f"  {final_progression[i:i+8]}")
