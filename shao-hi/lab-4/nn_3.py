...
#
# This is more concise than nn_2.py. It uses higher-level abstractions and hides
...
all_chords = [c for row in df["chords"] if row for c in row]
...
print(f"\nOverall test accuracy: {(preds == y_test).float().mean():.1%}\n")
