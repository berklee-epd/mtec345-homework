...
kenv      expon     1, idur, 0.1
kf        =         1.16 * (kcut + kenv * kenvtof)
kf        =         (kf > 1.16 ? 1.16 : kf)
kfb       =         krez * (1.0 - 0.15 * kf * kf)
kscale    =         kf / 1.3
...
at1       =         kscale * api   
aout1     =         at1 + 0.3 * ain1 + (1.0 - kf) * aout1
ain1      =         at1
at2       =         kscale * aout1
aout2     =         at2 + 0.3 * ain2 + (1.0 - kf) * aout2
ain2      =         at2
at3       =         kscale * aout2
aout3     =         at3 + 0.3 * ain3 + (1.0 - kf) * aout3
ain3      =         at3
at4       =         kscale * aout3
aout4     =         at4 + 0.3 * ain4 + (1.0 - kf) * aout4
ain4      =         at4
